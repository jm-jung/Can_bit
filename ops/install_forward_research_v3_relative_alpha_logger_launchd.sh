...
cd "$ROOT_DIR"
python scripts/diagnostics/run_forward_research_v3_relative_alpha_logger.py --dry-run --json
python scripts/diagnostics/run_forward_research_v3_relative_alpha_logger.py --once --json
