...
cd "$ROOT_DIR"
python scripts/diagnostics/run_forward_research_v4_orderflow_relative_logger.py --dry-run --json
python scripts/diagnostics/run_forward_research_v4_orderflow_relative_logger.py --once --json
